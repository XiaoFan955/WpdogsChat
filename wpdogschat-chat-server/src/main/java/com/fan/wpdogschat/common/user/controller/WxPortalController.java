...
public class WxPortalController {
    ...
    public String getQrCode() throws WxErrorException {
        WxMpQrCodeTicket wxMpQrCodeTicket = wxMpService.getQrcodeService().qrCodeCreateTmpTicket(2,1000);
    ...
    public RedirectView callBack(@RequestParam String code) throws WxErrorException {
        /**
         * 用户点击链接登陆后的回调，做一些业务处理，转发等工作
         * 先根据code获取accesstoken
         * 再利用accesstoken获取用户信息
         */
