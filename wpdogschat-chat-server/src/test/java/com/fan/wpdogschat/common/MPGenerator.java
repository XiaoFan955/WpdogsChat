...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //设置输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/wpdogschat-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("fan");
        ...
        packageConfig.setParent("com.fan.wpdogschat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("qy7ttvj7vg");
        dataSourceConfig.setUrl("jdbc:mysql://8.130.121.17:3306/wpdogschat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}